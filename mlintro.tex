...
Therefore VAEs, once trained to generate elements from points sampled nearby the latent space position where the training set events are encoded, matching as close as possible the  training set itself, 
