...
Results are shown in Figure~\ref{fig:calogan1} for the explicit targets of the calculation (2-D layered images of the energy deposits, in the specific case of incoming positrons.
...
\begin{figure}[h]
    ...
    \caption{Average e$^+$ GEANT4 shower (top), and average e$^+$
CALOGAN shower (bottom), with progressive calorimeter depth
(left to right). (From: \cite{calogan}).}
    \label{fig:calogan1}
    \end{subfigure}
    \hfill
        \begin{subfigure}[b]{0.44\textwidth}
        \includegraphics[width=1\textwidth]{images/calogan2.png}
     \caption{Energy weighted shower depth, from CALOGAN and Geant4 detailed simulations. (From: \cite{calogan}).}
     \label{fig:calogan2}
        \end{subfigure}
\end{figure}


Interestingly, one can look into quantities derived from shower shapes, but not directly targeted by the GAN training step, like for example the energy weighted shower depth. As we will see in Section~\ref{subsec:speed}, in general one cannot assume these quantities will be perfectly reproduced; in this specific case, though, the agreeement level is quite impressive.
...
Figure~\ref{fig:3dgan_shower_longitudinal} shows the longitudinal shower shapes for 100 GeV electrons in the electromagnetic part of the calorimeter compared with detailed Geant4 simulations. The level of agreement is very satisfactory. Figure~\ref{fig:3dgan1} shows a pictorial rendering of the exepcter energy deposit by a 100 GeV electron in the calorimeter.
...
\caption{Longitudinal shower shapes for 100 GeV electrons: GAN result is compared to full Geant4
simulation. The Z coordinate indicates the bin index in the longitudinal direction. (From:\cite{3dgan}}
\label{fig:3dgan_shower_longitudinal}
    \end{subfigure}
    \hfill
        \begin{subfigure}[b]{0.44\textwidth}
        \includegraphics [width=\textwidth]{images/3dgan1.png}
\caption{The three-dimensional representation of an energy shower created by a 100
